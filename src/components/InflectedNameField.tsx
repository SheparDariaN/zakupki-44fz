...
const defaultInputClass = 'border border-line px-3 py-2 text-sm bg-surface focus:outline-none focus:ring-1 focus:ring-ink';
...
export default function InflectedNameField({
  ...
  return (
    <div className={`flex flex-col ${className}`.trim()}>
      ...
      {hasValue && (
        <div className="mt-2 border border-line bg-page/50 p-3">
          ...
          <div className="flex flex-col gap-2">
            <div className="grid grid-cols-[38px_1fr] gap-2 items-center">
              ...
              <div className="border border-line/20 bg-surface/70 px-2 py-1.5 text-xs break-words">
                {auto.nominative}
              </div>
            </div>
            <label className="grid grid-cols-[38px_1fr] gap-2 items-center">
              ...
              <input
                type="text"
                className="border border-line bg-surface px-2 py-1.5 text-xs focus:outline-none focus:ring-1 focus:ring-ink"
